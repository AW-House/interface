...
const CHAIN_SUBGRAPH_URL: Record<number, string> = {
  ...
  // [ChainId.REDSTONE_GARNET]: 'https://graph.stg.swap-redstone.w3us.site/subgraphs/name/swap-v3-redstone-garnet',
  // [ChainId.REDSTONE]: 'https://graph.stg.swap-redstone.w3us.site/subgraphs/name/swap-v3-redstone-mainnet',
}
...
export const chainToApolloClient: Record<number, ApolloClient<NormalizedCacheObject>> = {
  ...
  // [ChainId.REDSTONE_GARNET]: new ApolloClient({
  //   cache: new InMemoryCache(),
  //   uri: CHAIN_SUBGRAPH_URL[ChainId.REDSTONE_GARNET],
  // }),
  // [ChainId.REDSTONE]: new ApolloClient({
  //   cache: new InMemoryCache(),
  //   uri: CHAIN_SUBGRAPH_URL[ChainId.REDSTONE],
  // }),
}
